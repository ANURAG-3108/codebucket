...
public class EmployeeComparatorDemo {
	...
	public static void main(String[] args) {
		...
		Collections.sort(list,new EmployeeComparator.IDComparator());
		System.out.println("Employee ID Based Sorting "
				+ list.get(0).getId()+ " : " +list.get(1).getId()+" : "+list.get(2).getId());
